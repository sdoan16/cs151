public class Connection
{
   ...
   */
   private void resetConnection()
   {
      ...
      //CHANGED INITIAL_PROMPT TO MMENU
   }	
   ...
   */
   private void changeGreeting(String key)
   {
    ...
    public void initialSetting(String key)
    {
    	if(key.equals("1"))
    		{
    			state = CONNECTED;
    	...
    	if(("0123456789#").contains(key) && key.length() > 1)
    	{
    		phone.speak(LOGIN);
    	}
   ...
   */
   private void mailboxMenu(String key)
   {
      ...
      {
    	  //Repeat menu if user enters incorrect key
    	  phone.speak(MAILBOX_MENU_TEXT);
      }
   }
   ...
   */
   ...
   private static final int FIRST_STATE = 7;
   private static final int ALMOST_CONNECTED = 8;

   private static final String INITIAL_PROMPT = 
         "Enter mailbox number followed by #";   
   private static final String INITIAL_TWO = "Please enter your mailbox number followed by # ";
   private static final String LOGIN = "Please enter your passcode followed by # ";
   ...
   private static final String MMENU = "SYSTEM: To leave a message to a "
   										+ "mailbox, press (1), to access"
   										+" a mailbox, press (2).";
}
